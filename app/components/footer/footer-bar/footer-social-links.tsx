      ...
      <li>
          <Link href="https://github.com/Sai24020">
            <Image
              ...
              width={33}
              height={33}
              className="hover:opacity-50 transition-opacity fill-white hidden"
            />
            <GithubIcon className="border-0 rounded-4xl h-9 w-9 hover:opacity-50 transition-opacity text-gray-700 bg-white"/>
          </Link>
        </li>
        <li>
